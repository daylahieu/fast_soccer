...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:1999/user/pay?id=";
    public static String vnp_TmnCode = "UMQICAH5";
    public static String vnp_HashSecret = "HRDQWYYMEZYKUBXNDSAHJMWZSDCFJMOB";
